...
res = Optim.optimize(f, g!, rec0, LBFGS(linesearch=LineSearches.BackTracking()), Optim.Options(iterations=40))

# ╔═╡ f55b0aa2-4de9-43ab-9a30-3d1a7bc85984
res_cuda = Optim.optimize(f, g!, rec0_cuda, LBFGS(linesearch=LineSearches.BackTracking()), Optim.Options(iterations=40))
...
# ╔═╡ 62bf0c1a-2c67-4688-ac2f-bd932a9ae0ae
GC.gc(true)
